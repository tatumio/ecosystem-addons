...
export const DERIVATION_PATHS = new Map<Network, string>([
  ...
  [Network.OPTIMISM, EVM_DERIVATION_PATH_COMMON], //TODO: missing
  [Network.PALM, EVM_DERIVATION_PATH_COMMON], //TODO: missing
